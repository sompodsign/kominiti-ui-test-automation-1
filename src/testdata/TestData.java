...
public class TestData {
    ...
    public static String getRandomEmail() {
        ...
        email = getRandomFirstName() + "_" + getRandomNumber() + getRandomFirstName() + "@" + domains[(int) (Math.random() * domains.length)];
    ...
    public static String getRandomWebsite() {
        return "www."+getRandomFirstName().toLowerCase()+getRandomDigits(3)+getRandomFirstName().toLowerCase()+".com";
    }
    ...
    public static void writeCounter(int count) {
        ...
        // write properties
        try {
            OutputStream output = Files.newOutputStream(Paths.get("src/testdata/aliasCounter.properties"));
    ...
    public static int readCounter() {
        ...
        // read properties
        try {
            InputStream input = Files.newInputStream(Paths.get("src/testdata/aliasCounter.properties"));
            Properties prop = new Properties();
            prop.load(input);
    ...
    public static String generateAliasGmail() throws IOException {
        writeCounter(readCounter());
        return "ss.unidev+" + readCounter() + "@gmail.com";
